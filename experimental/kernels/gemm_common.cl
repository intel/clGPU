...
#define GET_COL_half8( _block, _col )                               \
        (half8)( intel_sub_group_shuffle( _block, _col ));
...
#define MULTIPLY_BLOCKS_8x8_half8( _result, _blockA, _blockB )                \
        {                                                               \
            const half8    acol0 = GET_COL_half8( _blockA, 0 );            \
            const half8    acol1 = GET_COL_half8( _blockA, 1 );            \
            const half8    acol2 = GET_COL_half8( _blockA, 2 );            \
            const half8    acol3 = GET_COL_half8( _blockA, 3 );            \
            const half8    acol4 = GET_COL_half8( _blockA, 4 );            \
            const half8    acol5 = GET_COL_half8( _blockA, 5 );            \
            const half8    acol6 = GET_COL_half8( _blockA, 6 );            \
            const half8    acol7 = GET_COL_half8( _blockA, 7 );            \
            _result = mad( (half8)(_blockB.s0), acol0, _result );      \
            _result = mad( (half8)(_blockB.s1), acol1, _result );      \
            _result = mad( (half8)(_blockB.s2), acol2, _result );      \
            _result = mad( (half8)(_blockB.s3), acol3, _result );      \
            _result = mad( (half8)(_blockB.s4), acol4, _result );      \
            _result = mad( (half8)(_blockB.s5), acol5, _result );      \
            _result = mad( (half8)(_blockB.s6), acol6, _result );      \
            _result = mad( (half8)(_blockB.s7), acol7, _result );      \
        }
