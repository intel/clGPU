...
static const char* module_name = "Strmv_naive";
static const char* kernel_name = "Strmv_naive";

namespace iclgpu { namespace functions { namespace implementations {

bool Strmv_naive::accept(const Strmv::params& params, Strmv::score& score)
{
    return true;
}

event Strmv_naive::execute(const Strmv::params& params, const std::vector<event>& dep_events)
{
