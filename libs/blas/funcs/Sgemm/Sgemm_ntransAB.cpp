...
static const char* module_name = "Sgemm_ntransAB";
static const char* kernel_name = "Sgemm_ntransAB";

namespace iclgpu { namespace functions { namespace implementations {

bool Sgemm_ntransAB::accept(const Sgemm::params& params, Sgemm::score& score)
{
...
event Sgemm_ntransAB::execute(const Sgemm::params& params, const std::vector<event>& dep_events)
{
