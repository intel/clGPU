...
static const char* module_name = "Sgemm_ntransA_transB";
static const char* kernel_name = "Sgemm_ntransA_transB";

namespace iclgpu { namespace functions { namespace implementations {

bool Sgemm_ntransA_transB::accept(const Sgemm::params& params, Sgemm::score& score)
{
    if (params.transa == 0 && params.transb == 1)
    {
        score.transa = 1.15f;
        score.transb = 1.15f;
...
event Sgemm_ntransA_transB::execute(const Sgemm::params& params, const std::vector<event>& dep_events)
{
