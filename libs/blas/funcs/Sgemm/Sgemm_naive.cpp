...
static const char* module_name = "Sgemm_naive";
static const char* kernel_name = "Sgemm_naive";

namespace iclgpu { namespace functions { namespace implementations {

bool Sgemm_naive::accept(const Sgemm::params& params, Sgemm::score& score)
{
    return true;
}

event Sgemm_naive::execute(const Sgemm::params& params, const std::vector<event>& dep_events)
{
