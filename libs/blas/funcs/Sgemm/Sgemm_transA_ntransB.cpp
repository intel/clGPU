...
static const char* module_name = "Sgemm_transA_ntransB";
static const char* kernel_name = "Sgemm_transA_ntransB";

namespace iclgpu { namespace functions { namespace implementations {

bool Sgemm_transA_ntransB::accept(const Sgemm::params& params, Sgemm::score& score)
{
    if (params.transa == 1 && params.transb == 0)
    {
        score.transa = 1.15f;
        score.transb = 1.15f;
...
event Sgemm_transA_ntransB::execute(const Sgemm::params& params, const std::vector<event>& dep_events)
{
