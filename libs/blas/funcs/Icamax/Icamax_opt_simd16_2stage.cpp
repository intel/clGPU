...
static const char* module_name = "Icamax_opt_simd16_2stage";
static const char* first_stage_kernel_name = "Icamax_opt_simd16_2stage";
static const char* second_stage_kernel_name = "Icamax_opt_simd16_2stage_2";
...
bool Icamax_opt_simd16_2stage::accept(const Icamax::params& params, Icamax::score& score)
{
...
event Icamax_opt_simd16_2stage::execute(const Icamax::params& params, const std::vector<event>& dep_events)
{
