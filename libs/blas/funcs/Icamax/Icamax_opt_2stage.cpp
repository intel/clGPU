...
static const char* module_name = "Icamax_opt_2stage";
static const char* kernel_name = "Icamax_opt_2stage";
...
bool Icamax_opt_2stage::accept(const Icamax::params& params, Icamax::score& score)
{
...
event Icamax_opt_2stage::execute(const Icamax::params& params, const std::vector<event>& dep_events)
{
