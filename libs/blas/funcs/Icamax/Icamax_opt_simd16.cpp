...
static const char* module_name = "Icamax_opt_simd16";
static const char* kernel_name = "Icamax_opt_simd16";
...
bool Icamax_opt_simd16::accept(const Icamax::params& params, Icamax::score& score)
{
...
event Icamax_opt_simd16::execute(const Icamax::params& params, const std::vector<event>& dep_events)
{
