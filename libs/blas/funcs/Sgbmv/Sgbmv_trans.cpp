...
static const char* module_name = "Sgbmv_trans";
static const char* kernel_name = "Sgbmv_trans";

namespace iclgpu { namespace functions { namespace implementations {

#define ICLBLAS_OP_N 0

bool Sgbmv_trans::accept(const Sgbmv::params& params, Sgbmv::score& score)
{
...
event Sgbmv_trans::execute(const Sgbmv::params& params, const std::vector<event>& dep_events)
{
