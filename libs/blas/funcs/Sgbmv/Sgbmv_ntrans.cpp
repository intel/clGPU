...
static const char* module_name = "Sgbmv_ntrans";
static const char* kernel_name = "Sgbmv_ntrans";

namespace iclgpu { namespace functions { namespace implementations {

#define ICLBLAS_OP_N 0

bool Sgbmv_ntrans::accept(const Sgbmv::params& params, Sgbmv::score& score)
{
...
event Sgbmv_ntrans::execute(const Sgbmv::params& params, const std::vector<event>& dep_events)
{
