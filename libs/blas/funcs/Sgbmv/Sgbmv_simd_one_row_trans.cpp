...
static const char* module_name = "Sgbmv_simd_one_row_trans";
...
bool Sgbmv_simd_one_row_trans::accept(const Sgbmv::params& params, Sgbmv::score& score)
{
...
event Sgbmv_simd_one_row_trans::execute(const Sgbmv::params& params, const std::vector<event>& dep_events)
{
