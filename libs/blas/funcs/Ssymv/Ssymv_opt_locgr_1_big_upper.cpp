...
static const char* module_name = "Ssymv_opt_locgr_1_big_upper";
static const char* kernel_name = "Ssymv_opt_locgr_1_big_upper";
...
bool Ssymv_opt_locgr_1_big_upper::accept(const Ssymv::params& params, Ssymv::score& score)
{
...
event Ssymv_opt_locgr_1_big_upper::execute(const Ssymv::params& params, const std::vector<event>& dep_events)
{
