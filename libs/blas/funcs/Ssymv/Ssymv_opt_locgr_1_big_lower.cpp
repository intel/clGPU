...
static const char* module_name = "Ssymv_opt_locgr_1_big_lower";
static const char* kernel_name = "Ssymv_opt_locgr_1_big_lower";
...
bool Ssymv_opt_locgr_1_big_lower::accept(const Ssymv::params& params, Ssymv::score& score)
{
    if (params.n >= WORK_ITEMS && params.uplo == ICLBLAS_FILL_MODE_LOWER)
    {
        score.n = 1.5f;
        score.uplo = 1.1f;
        return true;
...
event Ssymv_opt_locgr_1_big_lower::execute(const Ssymv::params& params, const std::vector<event>& dep_events)
{
