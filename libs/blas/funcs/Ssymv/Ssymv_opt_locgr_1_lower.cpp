...
static const char* module_name = "Ssymv_opt_locgr_1_lower";
static const char* kernel_name = "Ssymv_opt_locgr_1_lower";
...
bool Ssymv_opt_locgr_1_lower::accept(const Ssymv::params& params, Ssymv::score& score)
{
...
event Ssymv_opt_locgr_1_lower::execute(const Ssymv::params& params, const std::vector<event>& dep_events)
{
