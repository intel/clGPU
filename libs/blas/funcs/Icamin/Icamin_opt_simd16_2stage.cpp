...
static const char* module_name = "Icamin_opt_simd16_2stage";
static const char* first_stage_kernel_name = "Icamin_opt_simd16_2stage";
static const char* second_stage_kernel_name = "Icamin_opt_simd16_2stage_2";
...
bool Icamin_opt_simd16_2stage::accept(const Icamin::params& params, Icamin::score& score)
{
...
event Icamin_opt_simd16_2stage::execute(const Icamin::params& params, const std::vector<event>& dep_events)
{
