...
static const char* module_name = "Icamin_opt_simd16";
static const char* kernel_name = "Icamin_opt_simd16";
...
bool Icamin_opt_simd16::accept(const Icamin::params& params, Icamin::score& score)
{
...
event Icamin_opt_simd16::execute(const Icamin::params& params, const std::vector<event>& dep_events)
{
