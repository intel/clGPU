...
static const char* module_name = "Srot_noinc";
static const char* kernel_name = "Srot_noinc";

namespace iclgpu { namespace functions { namespace implementations {

bool Srot_noinc::accept(const Srot::params& params, Srot::score& score)
{
...
event Srot_noinc::execute(const Srot::params& params, const std::vector<event>& dep_events)
{
