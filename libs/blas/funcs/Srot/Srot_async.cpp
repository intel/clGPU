...
static const char* module_name = "Srot_async";
static const char* kernel_name = "Srot_async";

namespace iclgpu { namespace functions { namespace implementations {

bool Srot_async::accept(const Srot::params& params, Srot::score& score)
{
    score.n = 1.25;
...
event Srot_async::execute(const Srot::params& params, const std::vector<event>& dep_events)
{
