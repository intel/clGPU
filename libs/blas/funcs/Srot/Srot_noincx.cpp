...
static const char* module_name = "Srot_noincx";
static const char* kernel_name = "Srot_noincx";

namespace iclgpu { namespace functions { namespace implementations {

bool Srot_noincx::accept(const Srot::params& params, Srot::score& score)
{
...
event Srot_noincx::execute(const Srot::params& params, const std::vector<event>& dep_events)
{
