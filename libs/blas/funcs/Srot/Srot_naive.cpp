...
static const char* module_name = "Srot_naive";
static const char* kernel_name = "Srot_naive";

namespace iclgpu { namespace functions { namespace implementations {

bool Srot_naive::accept(const Srot::params& params, Srot::score& score)
{
    return true;
}

event Srot_naive::execute(const Srot::params& params, const std::vector<event>& dep_events)
{
