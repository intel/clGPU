...
static const char* module_name = "Ssbmv_naive";
static const char* kernel_name = "Ssbmv_naive";

namespace iclgpu { namespace functions { namespace implementations {

bool Ssbmv_naive::accept(const Ssbmv::params& params, Ssbmv::score& score)
{
    return true;
}

event Ssbmv_naive::execute(const Ssbmv::params& params, const std::vector<event>& dep_events)
{
