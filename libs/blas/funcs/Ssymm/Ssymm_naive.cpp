...
static const char* module_name = "Ssymm_naive";
static const char* kernel_name = "Ssymm_naive";

namespace iclgpu { namespace functions { namespace implementations {

bool Ssymm_naive::accept(const Ssymm::params& params, Ssymm::score& score)
{
    return true;
}

event Ssymm_naive::execute(const Ssymm::params& params, const std::vector<event>& dep_events)
{
    ...
    size_t a_buf_size;
    if (params.side == 0)
        a_buf_size = params.m * params.lda;
    else
        a_buf_size = params.n * params.lda;
