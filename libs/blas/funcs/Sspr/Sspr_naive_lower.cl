...
__kernel void Sspr_naive_lower(int n, float alpha, __global float* x, int incx, __global float* AP)
{
    ...
    if(row_id >= col_id)
    {
        ...
        LS_ACCESS(AP, row_id, col_id, n) = res_1 + LS_ACCESS(AP, row_id, col_id, n);
    }
}
