...
static const char* module_name = "Sspr_naive_upper";
static const char* kernel_name = "Sspr_naive_upper";

namespace iclgpu {
    namespace functions {
        namespace implementations {

            bool Sspr_naive_upper::accept(const Sspr::params& params, Sspr::score& score)
            {
                if (params.uplo == 0)
                {
                    score.uplo = 2.0f;
            ...
            event Sspr_naive_upper::execute(const Sspr::params& params, const std::vector<event>& dep_events)
            {
