...
static const char* module_name = "Csrot_noincy";
static const char* kernel_name = "Csrot_noincy";

namespace iclgpu { namespace functions { namespace implementations {

bool Csrot_noincy::accept(const Csrot::params& params, Csrot::score& score)
{
...
event Csrot_noincy::execute(const Csrot::params& params, const std::vector<event>& dep_events)
{
