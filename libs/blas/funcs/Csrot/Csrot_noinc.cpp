...
static const char* module_name = "Csrot_noinc";
static const char* kernel_name = "Csrot_noinc";

namespace iclgpu { namespace functions { namespace implementations {

bool Csrot_noinc::accept(const Csrot::params& params, Csrot::score& score)
{
...
event Csrot_noinc::execute(const Csrot::params& params, const std::vector<event>& dep_events)
{
    ...
    kernel->set_arg(2, params.c);
    kernel->set_arg(3, params.s);
