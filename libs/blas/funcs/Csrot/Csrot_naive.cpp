...
static const char* module_name = "Csrot_naive";
static const char* kernel_name = "Csrot_naive";

namespace iclgpu { namespace functions { namespace implementations {

bool Csrot_naive::accept(const Csrot::params& params, Csrot::score& score)
{
    return true;
}

event Csrot_naive::execute(const Csrot::params& params, const std::vector<event>& dep_events)
{
    ...
    kernel->set_arg(5, params.c);
    kernel->set_arg(6, params.s);
