...
static const char* module_name = "Chemm_naive";
static const char* kernel_name = "Chemm_naive";

namespace iclgpu { namespace functions { namespace implementations {

#define ICLBLAS_SIDE_LEFT 0

bool Chemm_naive::accept(const Chemm::params& params, Chemm::score& score)
{
    return true;
}

event Chemm_naive::execute(const Chemm::params& params, const std::vector<event>& dep_events)
{
