...
static const char* module_name = "Ssyr_simd16x1x1_lower";
static const char* kernel_name = "Ssyr_simd16x1x1_lower";
...
bool Ssyr_simd16x1x1_lower::accept(const Ssyr::params& params, Ssyr::score& score)
{
...
event Ssyr_simd16x1x1_lower::execute(const Ssyr::params& params, const std::vector<event>& dep_events)
{
    ...
    int tiles_one_side = (params.n + simd - 1) / simd;
