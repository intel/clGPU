...
// Each tile has size 16x16 - calculated by single sub group
// One work item calculates 1x16 (one row from tile)
__attribute__((intel_reqd_sub_group_size(SIMD)))
__attribute__((reqd_work_group_size(SIMD, 1, 1)))
__kernel void Ssyr_simd16x1x1_lower(uint n, float alpha, __global float* x, uint incx, __global float* a, uint lda)
{
