...
static const char* module_name = "Ssyr_simd16x4x4_upper";
static const char* kernel_name = "Ssyr_simd16x4x4_upper";
...
bool Ssyr_simd16x4x4_upper::accept(const Ssyr::params& params, Ssyr::score& score)
{
    if (params.uplo != ICLBLAS_FILL_MODE_UPPER || params.lda % vec_size != 0) return false;
    score.uplo = 1.1f;
    score.lda = 1.4f;
    return true;
}

event Ssyr_simd16x4x4_upper::execute(const Ssyr::params& params, const std::vector<event>& dep_events)
{
