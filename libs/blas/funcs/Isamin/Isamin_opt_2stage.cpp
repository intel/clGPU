...
static const char* module_name = "Isamin_opt_2stage";
static const char* kernel_name = "Isamin_opt_2stage";
...
bool Isamin_opt_2stage::accept(const Isamin::params& params, Isamin::score& score)
{
...
event Isamin_opt_2stage::execute(const Isamin::params& params, const std::vector<event>& dep_events)
{
