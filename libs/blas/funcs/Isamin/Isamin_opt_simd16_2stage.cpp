...
static const char* module_name = "Isamin_opt_simd16_2stage";
static const char* first_stage_kernel_name = "Isamin_opt_simd16_2stage";
static const char* second_stage_kernel_name = "Isamin_opt_simd16_2stage_2";
...
bool Isamin_opt_simd16_2stage::accept(const Isamin::params& params, Isamin::score& score)
{
...
event Isamin_opt_simd16_2stage::execute(const Isamin::params& params, const std::vector<event>& dep_events)
{
    ...
    auto lws = nd_range(LOCAL_GROUP_SIZE);
