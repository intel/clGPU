...
static const char* module_name = "Cgbmv_conjg";
static const char* kernel_name = "Cgbmv_conjg";

namespace iclgpu { namespace functions { namespace implementations {

#define ICLBLAS_OP_C 2

bool Cgbmv_conjg::accept(const Cgbmv::params& params, Cgbmv::score& score)
{
    if (params.trans != ICLBLAS_OP_C)
        return false;
    return true;
}

event Cgbmv_conjg::execute(const Cgbmv::params& params, const std::vector<event>& dep_events)
{
