...
static const char* module_name = "Ctbmv_naive";
static const char* kernel_name = "Ctbmv_naive";

namespace iclgpu { namespace functions { namespace implementations {

bool Ctbmv_naive::accept(const Ctbmv::params& params, Ctbmv::score& score)
{
    return true;
}

event Ctbmv_naive::execute(const Ctbmv::params& params, const std::vector<event>& dep_events)
{
