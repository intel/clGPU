...
static const char* module_name = "Scnrm2_naive";
static const char* kernel_name = "Scnrm2_naive";

namespace iclgpu { namespace functions { namespace implementations {

bool Scnrm2_naive::accept(const Scnrm2::params& params, Scnrm2::score& score)
{
    score.n = 1.05f;
    return true;
}

event Scnrm2_naive::execute(const Scnrm2::params& params, const std::vector<event>& dep_events)
{
