...
static const char* module_name = "Sger_float4";
static const char* kernel_name = "Sger_float4";

static const int vec_size = 4;

namespace iclgpu { namespace functions { namespace implementations {

bool Sger_float4::accept(const Sger::params& params, Sger::score& score)
{
...
event Sger_float4::execute(const Sger::params& params, const std::vector<event>& dep_events)
{
    ...
    auto gws = nd_range((params.m + vec_size - 1) / vec_size, params.n);
    auto lws = null_range;
