...
static const char* module_name = "Sasum_simd16_two_stage_noinc";
static const char* first_kernel_name = "Sasum_simd16_first_stage_noinc";
static const char* second_kernel_name = "Sasum_simd16_second_stage_noinc";
...
bool Sasum_simd16_two_stage_noinc::accept(const Sasum::params& params, Sasum::score& score)
{
    if (params.incx != 1) {
        return false;
    }
...
event Sasum_simd16_two_stage_noinc::execute(const Sasum::params& params, const std::vector<event>& dep_events)
{
    ...
    first_kernel->set_arg(2, buf_group_sums);
