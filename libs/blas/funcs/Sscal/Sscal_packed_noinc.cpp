...
static const char* module_name = "Sscal_packed_noinc";
static const char* kernel_name = "Sscal_packed_noinc";

static const int lwg_size = 32;
static const int wi_elems = 1;
static const int vec_size = 4;

static const int lwg_elems = lwg_size * wi_elems * vec_size;

namespace iclgpu { namespace functions { namespace implementations {

bool Sscal_packed_noinc::accept(const Sscal::params& params, Sscal::score& score)
{
...
event Sscal_packed_noinc::execute(const Sscal::params& params, const std::vector<event>& dep_events)
{
