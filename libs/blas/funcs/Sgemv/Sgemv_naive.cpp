...
static const char* module_name = "Sgemv_naive";
static const char* kernel_name = "Sgemv_naive";

namespace iclgpu { namespace functions { namespace implementations {

bool Sgemv_naive::accept(const Sgemv::params& params, Sgemv::score& score)
{
    return true;
}

event Sgemv_naive::execute(const Sgemv::params& params, const std::vector<event>& dep_events)
{
