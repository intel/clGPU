...
__kernel void Sgemv_naive_async(int trans, int m, int n, float alpha, __global float* A, int lda, __global float* x, int incx, float beta, __global float* y, int incy)
{
    /* Each thread calculates it's own result for vector y */
