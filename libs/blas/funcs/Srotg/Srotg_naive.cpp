...
static const char* module_name = "Srotg_naive";
static const char* kernel_name = "Srotg_naive";

namespace iclgpu { namespace functions { namespace implementations {

bool Srotg_naive::accept(const Srotg::params& params, Srotg::score& score)
{
    return true;
}

event Srotg_naive::execute(const Srotg::params& params, const std::vector<event>& dep_events)
{
