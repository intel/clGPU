...
static const char* module_name = "Srotm_noinc_diagonal_ones";
...
bool Srotm_noinc_diagonal_ones::accept(const Srotm::params& params, Srotm::score& score)
{
    if (params.param[0] != 0.f || params.n < tile || params.incx != 1 || params.incy != 1) return false;
    score.param = 1.1f;
    score.n = 1.1f;
    score.incx = 1.1f;
    score.incx = 1.1f;
...
event Srotm_noinc_diagonal_ones::execute(const Srotm::params& params, const std::vector<event>& dep_events)
{
