...
static const char* module_name = "Srotm_packed_full";
...
bool Srotm_packed_full::accept(const Srotm::params& params, Srotm::score& score)
{
...
event Srotm_packed_full::execute(const Srotm::params& params, const std::vector<event>& dep_events)
{
