...
static const char* module_name = "Srotm_async_diagonal_ones";
static const char* kernel_name = "Srotm_async";

namespace iclgpu { namespace functions { namespace implementations {

bool Srotm_async_diagonal_ones::accept(const Srotm::params& params, Srotm::score& score)
{
    if (params.param[0] != 0.f) return false;
    score.param = 1.1f;
    return true;
}

event Srotm_async_diagonal_ones::execute(const Srotm::params& params, const std::vector<event>& dep_events)
{
