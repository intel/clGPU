...
static const char* module_name = "Srotm_async_full";
static const char* kernel_name = "Srotm_async";

namespace iclgpu { namespace functions { namespace implementations {

bool Srotm_async_full::accept(const Srotm::params& params, Srotm::score& score)
{
...
event Srotm_async_full::execute(const Srotm::params& params, const std::vector<event>& dep_events)
{
