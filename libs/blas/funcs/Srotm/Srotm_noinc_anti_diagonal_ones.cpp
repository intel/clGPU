...
static const char* module_name = "Srotm_noinc_anti_diagonal_ones";
...
bool Srotm_noinc_anti_diagonal_ones::accept(const Srotm::params& params, Srotm::score& score)
{
...
event Srotm_noinc_anti_diagonal_ones::execute(const Srotm::params& params, const std::vector<event>& dep_events)
{
