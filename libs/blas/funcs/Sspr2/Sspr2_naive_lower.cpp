...
static const char* module_name = "Sspr2_naive_lower";
static const char* kernel_name = "Sspr2_naive_lower";

namespace iclgpu {
    namespace functions {
        namespace implementations {

            bool Sspr2_naive_lower::accept(const Sspr2::params& params, Sspr2::score& score)
            {
                if (params.uplo == 1)
                {
                    score.uplo = 2.0f;
            ...
            event Sspr2_naive_lower::execute(const Sspr2::params& params, const std::vector<event>& dep_events)
            {
