...
static const char* module_name = "Crot_async";
static const char* kernel_name = "Crot_async";

namespace iclgpu { namespace functions { namespace implementations {

bool Crot_async::accept(const Crot::params& params, Crot::score& score)
{
    score.n = 1.25f;
...
event Crot_async::execute(const Crot::params& params, const std::vector<event>& dep_events)
{
