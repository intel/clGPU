...
static const char* module_name = "Crot_noincy";
static const char* kernel_name = "Crot_noincy";

namespace iclgpu { namespace functions { namespace implementations {

bool Crot_noincy::accept(const Crot::params& params, Crot::score& score)
{
...
event Crot_noincy::execute(const Crot::params& params, const std::vector<event>& dep_events)
{
