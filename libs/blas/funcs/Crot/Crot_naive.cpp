...
static const char* module_name = "Crot_naive";
static const char* kernel_name = "Crot_naive";

namespace iclgpu { namespace functions { namespace implementations {

bool Crot_naive::accept(const Crot::params& params, Crot::score& score)
{
    return true;
}

event Crot_naive::execute(const Crot::params& params, const std::vector<event>& dep_events)
{
