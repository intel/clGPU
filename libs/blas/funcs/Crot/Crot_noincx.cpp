...
static const char* module_name = "Crot_noincx";
static const char* kernel_name = "Crot_noincx";

namespace iclgpu { namespace functions { namespace implementations {

bool Crot_noincx::accept(const Crot::params& params, Crot::score& score)
{
...
event Crot_noincx::execute(const Crot::params& params, const std::vector<event>& dep_events)
{
