...
static const char* module_name = "Crot_noinc";
static const char* kernel_name = "Crot_noinc";

namespace iclgpu { namespace functions { namespace implementations {

bool Crot_noinc::accept(const Crot::params& params, Crot::score& score)
{
...
event Crot_noinc::execute(const Crot::params& params, const std::vector<event>& dep_events)
{
