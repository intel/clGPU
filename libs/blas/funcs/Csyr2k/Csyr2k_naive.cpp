...
static const char* module_name = "Csyr2k_naive";
static const char* kernel_name = "Csyr2k_naive";

namespace iclgpu { namespace functions { namespace implementations {

bool Csyr2k_naive::accept(const Csyr2k::params& params, Csyr2k::score& score)
{
    return true;
}

event Csyr2k_naive::execute(const Csyr2k::params& params, const std::vector<event>& dep_events)
{
    auto engine = context()->get_engine();
    auto kernel = engine->get_kernel(kernel_name, module_name);
    size_t a_buf_size = params.trans == 0 ? params.lda * params.k : params.lda * params.n;
    size_t b_buf_size = params.trans == 0 ? params.ldb * params.k : params.ldb * params.n;
