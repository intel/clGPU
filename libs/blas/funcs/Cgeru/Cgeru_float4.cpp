...
static const char* module_name = "Cgeru_float4";
static const char* kernel_name = "Cgeru_float4";

namespace iclgpu { namespace functions { namespace implementations {

bool Cgeru_float4::accept(const Cgeru::params& params, Cgeru::score& score)
{
...
event Cgeru_float4::execute(const Cgeru::params& params, const std::vector<event>& dep_events)
{
