...
static const char* module_name = "Isamax_naive";
static const char* kernel_name = "Isamax_naive";

namespace iclgpu { namespace functions { namespace implementations {

bool Isamax_naive::accept(const Isamax::params& params, Isamax::score& score)
{
    return true;
}

event Isamax_naive::execute(const Isamax::params& params, const std::vector<event>& dep_events)
{
