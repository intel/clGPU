...
static const char* module_name = "Isamax_opt_simd16";
static const char* kernel_name = "Isamax_opt_simd16";
...
bool Isamax_opt_simd16::accept(const Isamax::params& params, Isamax::score& score)
{
...
event Isamax_opt_simd16::execute(const Isamax::params& params, const std::vector<event>& dep_events)
{
