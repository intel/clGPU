...
static const char* module_name = "Ssyr2k_naive";
static const char* kernel_name = "Ssyr2k_naive";

namespace iclgpu { namespace functions { namespace implementations {

bool Ssyr2k_naive::accept(const Ssyr2k::params& params, Ssyr2k::score& score)
{
    return true;
}

event Ssyr2k_naive::execute(const Ssyr2k::params& params, const std::vector<event>& dep_events)
{
