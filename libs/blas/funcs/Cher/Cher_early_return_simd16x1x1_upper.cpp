...
static const char* module_name = "Cher_early_return_simd16x1x1_upper";
static const char* kernel_name = "Cher_early_return_simd16x1x1_upper";

static const int simd = 16;

namespace iclgpu { namespace functions { namespace implementations {

bool Cher_early_return_simd16x1x1_upper::accept(const Cher::params& params, Cher::score& score)
{
...
event Cher_early_return_simd16x1x1_upper::execute(const Cher::params& params, const std::vector<event>& dep_events)
{
