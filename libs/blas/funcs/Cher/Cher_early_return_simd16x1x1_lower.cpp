...
static const char* module_name = "Cher_early_return_simd16x1x1_lower";
static const char* kernel_name = "Cher_early_return_simd16x1x1_lower";

static const int simd = 16;

namespace iclgpu { namespace functions { namespace implementations {

bool Cher_early_return_simd16x1x1_lower::accept(const Cher::params& params, Cher::score& score)
{
    if (params.uplo != ICLBLAS_FILL_MODE_LOWER) return false;
    score.uplo = 1.2f;
    return true;
}

event Cher_early_return_simd16x1x1_lower::execute(const Cher::params& params, const std::vector<event>& dep_events)
{
