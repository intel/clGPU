...
static const char* module_name = "Cher_naive";
static const char* kernel_name = "Cher_naive";

namespace iclgpu { namespace functions { namespace implementations {

bool Cher_naive::accept(const Cher::params& params, Cher::score& score)
{
    return true;
}

event Cher_naive::execute(const Cher::params& params, const std::vector<event>& dep_events)
{
