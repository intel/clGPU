...
static const char* module_name = "Caxpy_noinc";
static const char* kernel_name = "Caxpy_noinc";

namespace iclgpu { namespace functions { namespace implementations {

bool Caxpy_noinc::accept(const Caxpy::params& params, Caxpy::score& score)
{
...
Caxpy_noinc::command_builder Caxpy_noinc::selected()
{
