...
static const char* module_name = "Snrm2_simd16_two_stage_noinc";
static const char* first_kernel_name = "Snrm2_simd16_first_stage_noinc";
static const char* second_kernel_name = "Snrm2_simd16_second_stage_noinc";
...
bool Snrm2_simd16_two_stage_noinc::accept(const Snrm2::params& params, Snrm2::score& score)
{
    if (params.incx != 1) {
        return false;
    }
...
event Snrm2_simd16_two_stage_noinc::execute(const Snrm2::params& params, const std::vector<event>& dep_events)
{
