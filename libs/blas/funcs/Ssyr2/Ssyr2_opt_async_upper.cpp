...
static const char* module_name = "Ssyr2_opt_async_upper";
static const char* kernel_name = "Ssyr2_opt_async_upper";
...
bool Ssyr2_opt_async_upper::accept(const Ssyr2::params& params, Ssyr2::score& score)
{
...
event Ssyr2_opt_async_upper::execute(const Ssyr2::params& params, const std::vector<event>& dep_events)
{
