...
static const char* module_name = "Cdotu_simd16_two_stage";
static const char* first_kernel_name = "Cdotu_simd16_first_stage";
static const char* second_kernel_name = "Cdotu_simd16_second_stage";
...
bool Cdotu_simd16_two_stage::accept(const Cdotu::params& params, Cdotu::score& score)
{
    if (params.n >= TILE) score.n = 1.3f;
    return true;
}

event Cdotu_simd16_two_stage::execute(const Cdotu::params& params, const std::vector<event>& dep_events)
{
