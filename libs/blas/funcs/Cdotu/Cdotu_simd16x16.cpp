...
static const char* module_name = "Cdotu_simd16x16";
static const char* kernel_name = "Cdotu_simd16x16";
...
bool Cdotu_simd16x16::accept(const Cdotu::params& params, Cdotu::score& score)
{
    if (params.n >= TILE) score.n = 1.2f;
    return true;
}

event Cdotu_simd16x16::execute(const Cdotu::params& params, const std::vector<event>& dep_events)
{
