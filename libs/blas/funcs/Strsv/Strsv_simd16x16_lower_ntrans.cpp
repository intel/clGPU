...
static const char* module_name = "Strsv_simd16x16_lower_ntrans";
...
bool Strsv_simd16x16_lower_ntrans::accept(const Strsv::params& params, Strsv::score& score)
{
    if (params.uplo != ICLBLAS_FILL_MODE_LOWER || params.trans != ICLBLAS_OP_N)
        return false;
    score.uplo = 1.1f;
    score.trans = 1.1f;
    return true;
...
event Strsv_simd16x16_lower_ntrans::execute(const Strsv::params& params, const std::vector<event>& dep_events)
{
