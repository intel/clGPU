...
static const char* module_name = "Strsv_simd16x16_upper_ntrans";
...
bool Strsv_simd16x16_upper_ntrans::accept(const Strsv::params& params, Strsv::score& score)
{
    if (params.uplo != ICLBLAS_FILL_MODE_UPPER || params.trans != ICLBLAS_OP_N) return false;
    score.n = 1.2f;
    return true;
}

event Strsv_simd16x16_upper_ntrans::execute(const Strsv::params& params, const std::vector<event>& dep_events)
{
