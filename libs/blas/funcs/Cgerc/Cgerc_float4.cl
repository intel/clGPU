...
__kernel void Cgerc_float4(uint m, complex_t alpha, __global complex_t* x, uint incx, __global complex_t* y, uint incy, __global float* a, uint lda)
{
    ...
    if (over) {
        ...
        float2 prod = cmul(this_x, conjg(this_y));
