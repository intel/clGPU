...
static const char* module_name = "Chpr2_early_return_simd16x1x1_lower";
static const char* kernel_name = "Chpr2_early_return_simd16x1x1_lower";

static const int simd = 16;

namespace iclgpu { namespace functions { namespace implementations {

bool Chpr2_early_return_simd16x1x1_lower::accept(const Chpr2::params& params, Chpr2::score& score)
{
...
event Chpr2_early_return_simd16x1x1_lower::execute(const Chpr2::params& params, const std::vector<event>& dep_events)
{
