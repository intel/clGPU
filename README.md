...
This technical preview includes [**iclBLAS**](include/iclBLAS) - Basic Linear Algebra Subprograms (BLAS) implementation optimized for Intel&reg; GPU.
...
- [include/iclBLAS](include/iclBLAS) - iclBLAS API
- [core](core) - the core library implementation
- [libs/blas](libs/blas) - iclBLAS API implementation

## Documentation

The online iclGPU documentation is at [GitHub pages](http://intel.github.io/clGPU)

Module specific documentation:
- [iclGPU Core Library](http://intel.github.io/clGPU/docs/iclgpu/html)
- [iclBLAS API](http://intel.github.io/clGPU/docs/iclBLAS/html)
...
We welcome community contributions to iclGPU. If you have an idea how to improve the library:
...
iclGPU supports Intel&reg; HD Graphics and Intel&reg; Iris&reg; Graphics and is optimized for
- Codename *Skylake*:
...
iclGPU currently uses OpenCL&trade; with multiple Intel&reg; OpenCL&trade; extensions and requires Intel&reg; Graphics Driver to run.

iclGPU requires CPU with Intel&reg; SSE/Intel&reg; AVX support.
...
Download [iclGPU source code](https://github.com/intel/clGPU/archive/master.zip)
...
iclGPU uses multiple 3<sup>rd</sup>-party components. They are stored in binary form in `common` subdirectory. Currently they are prepared for MSVC++ and GCC\*. They will be cloned with repository.

---

iclGPU uses a CMake-based build system. You can use CMake command-line tool or CMake GUI (`cmake-gui`) to generate required solution.  
...
You can generate documentation for the core library and iclBLAS separately.
